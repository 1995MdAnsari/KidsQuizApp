...
class KidsQuiz extends Component{
    ...
    showQuestions = () =>{
        ...
        return(
            ...
            <h3>Question Number : {s.currIndex+1}</h3>
            {s.errorMsg==='' ?'':<h5 className="text-danger">{s.errorMsg}</h5>}
            <div className="row ">
                    
            {  s.imgShow===1 ? <img src={arr.img} alt="images" 
                 className='img-fluid' style={{"width":"300px","height":"100%"}}
                />:''}
    ...
    handleAnswer = (num) =>{
        ...
        setTimeout(function(){
            ...
            else
            {
                ...
                {
                    s.errors++;
                    s.errorMsg = "Choose the correct answer";
                    s.show=1;
                }
            }
        ...
        if(s.arrNew[s.currIndex].Answer===num)
        this.setState({imgShow:1,errorMsg:''})
